...
impl core::fmt::Debug for McuSerialConn {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.debug_struct("McuSerialConn")
...
fn route_frame(
    ...
    let Some(tx) = tx else {
        tracing::warn!(
            ...
            correlation_id = cid,
            "McuSerialConn: response for unknown correlation_id dropped"
        );
        return;
    };
