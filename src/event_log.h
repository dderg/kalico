...
#define EVENT_LOG_EVENT_RUNTIME_PRIOR_RUN            23
#define EVENT_LOG_EVENT_RUNTIME_PRIOR_LIVE           24
#define EVENT_LOG_EVENT_RUNTIME_PRIOR_USB_OUT        25
#define EVENT_LOG_EVENT_RUNTIME_PRIOR_TASK_GAPS      26
...
#define EVENT_LOG_EVENT_MOTION_STEP_HALT        9
#define EVENT_LOG_EVENT_MOTION_STEP_CLOCK_HORIZON 10
#define EVENT_LOG_EVENT_MOTION_WIRE_PROBE_LATE 11
